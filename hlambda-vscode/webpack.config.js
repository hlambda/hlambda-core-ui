	...
	plugins: [
		new CopyPlugin({
			patterns: [
				...
				{
					from: 'resources/{initialize.js,*.svg}',
		...
		generate({
			...
			content: () => {
				...
				const extensions = [...vscodeExtensions, ...scanHlambdaExtensions()];
				return `window.hlambdaExtensions = ${JSON.stringify(extensions)};`;
			},
		}),
	],
	devServer: {
